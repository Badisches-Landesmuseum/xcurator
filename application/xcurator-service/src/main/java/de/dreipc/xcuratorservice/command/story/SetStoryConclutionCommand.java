...
@Service
public class SetStoryConclutionCommand {
    private final MongoTemplate mongoTemplate;

    public SetStoryConclutionCommand(MongoTemplate mongoTemplate) {
        this.mongoTemplate = mongoTemplate;
    }

    @Transactional
    public Story execute(ObjectId storyId, String conclusion) {
        ...
        if (conclusion.isBlank()) conclusion = null;
