import React, { forwardRef, createContext, useContext, Children } from 'react';
...
var Bleed = forwardRef(function (_a, forwardedRef) {
    ...
    return (React.createElement(Box, __assign({}, props, { ref: forwardedRef, as: as, display: as === 'span' ? 'block' : undefined, mt: mt, mb: mb, ml: ml, mr: mr }),
        React.createElement(Box, { display: as === 'span' ? 'block' : undefined, css: {
                position: 'relative',
            } }, children)));
});
...
var Columns = forwardRef(function (_a, forwardedRef) {
    var _b;
    ...
    return (React.createElement(Box, __assign({}, props, { ref: forwardedRef, marginLeft: negativeSpace, css: __assign({ display: 'flex', alignItems: alignItems, justifyContent: justifyContent }, collapseStyle) }),
        React.createElement(ColumnContext.Provider, { value: { paddingLeft: space, paddingTop: paddingTop } }, children)));
});
...
var Column = forwardRef(function (_a, forwardedRef) {
    var width = _a.width, children = _a.children, props = __rest(_a, ["width", "children"]);
    var _b = useContext(ColumnContext), paddingLeft = _b.paddingLeft, paddingTop = _b.paddingTop;
    return (React.createElement(ColumnBox, __assign({}, props, { ref: forwardedRef, css: {
        ...
        React.createElement(Box, { paddingLeft: paddingLeft, paddingTop: paddingTop, css: {
                height: '100%',
            } }, children)));
});
...
var Inline = forwardRef(function (_a, forwardedRef) {
    var _b, _c;
    var space = _a.space, alignX = _a.alignX, alignY = _a.alignY, collapse = _a.collapse, children = _a.children, props = __rest(_a, ["space", "alignX", "alignY", "collapse", "children"]);
    var negativeSpace = spaceToNegativeSpace(space);
    ...
    return (React.createElement(Box, { marginTop: negativeSpace },
        React.createElement(Inliner, __assign({}, props, { marginLeft: negativeSpace, alignX: alignX, alignY: alignY, css: inlinerStyles, ref: forwardedRef }), Children.map(flattenChildren(children), function (child) {
            return child !== null && child !== undefined ? (React.createElement(Box, { display: display, paddingLeft: space, paddingTop: space, css: childStyles }, child)) : null;
        }))));
});
...
var Placeholder = function (_a) {
    ...
    return (React.createElement(PlaceholderElem, { css: {
            width: width,
            height: height,
        } }, label ? (React.createElement(Box, { as: "p" }, label)) : (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("line", { x1: "0", y1: "0", x2: "100%", y2: "100%" }),
...
var Ratio = forwardRef(function (_a, forwardedRef) {
    var ratio = _a.ratio, children = _a.children, props = __rest(_a, ["ratio", "children"]);
    var styles = ratioStyles(ratio);
    return (React.createElement(Box, __assign({}, props, { css: styles, ref: forwardedRef }), children));
});
...
var Stack = forwardRef(function (_a, forwardedRef) {
    ...
    return (React.createElement(StackElem, __assign({}, props, { ref: forwardedRef, align: align }), stackItems.map(function (child, index) {
        return child !== null && child !== undefined ? (React.createElement(Box, { key: index, paddingBottom: index !== stackCount - 1 ? space : 0 },
            dividers && index > 0 ? (React.createElement(Box, { paddingBottom: space, css: {
                    width: '100%',
                } },
                React.createElement(Divider, { color: dividers }))) : null,
            child)) : null;
    })));
});
...
var Tiles = forwardRef(function (_a, forwardedRef) {
    var space = _a.space, _b = _a.columns, columns = _b === void 0 ? 1 : _b, children = _a.children, props = __rest(_a, ["space", "columns", "children"]);
    var negativeSpace = spaceToNegativeSpace(space);
    return (React.createElement(Box, { marginTop: negativeSpace },
        React.createElement(Box, __assign({}, props, { css: {
                display: 'flex',
                flexWrap: 'wrap',
            }, marginLeft: negativeSpace, ref: forwardedRef }), Children.map(flattenChildren(children), function (child) {
            return child !== null && child !== undefined ? (React.createElement(TileBox, { columns: columns, paddingLeft: space, paddingTop: space }, child)) : null;
        }))));
});
Tiles.displayName = 'Tiles';

export { Bleed, Box, Column, Columns, Flex, Grid, Inline, Placeholder, Ratio, Stack, Tiles, config, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
