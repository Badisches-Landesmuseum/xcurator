...
export declare const Inliner: import("@stitches/react/types/styled-component").StyledComponent<import("@stitches/react/types/styled-component").StyledComponent<"div", {
    ...
    alignX?: "left" | "right" | "center" | undefined;
...
declare const Inline: React.ForwardRefExoticComponent<Pick<InlineProps, "space" | "collapse" | "key" | keyof React.HTMLAttributes<HTMLDivElement> | "alignX" | "alignY"> & React.RefAttributes<HTMLDivElement>>;
export declare function variantToCss(property: string, variant?: Stitches.VariantProps<typeof Inliner>['alignX'], mapper?: {
    [key: string]: Stitches.CSSProperties['justifyContent'];
}): {
    [x: string]: import("@stitches/react/types/css").Property.JustifyContent;
} | undefined;
export declare type InlineProps = ComponentPropsWithRef<'div'> & {
    children?: ReactNode;
