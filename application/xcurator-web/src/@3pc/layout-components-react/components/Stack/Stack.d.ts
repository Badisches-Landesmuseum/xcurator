...
declare const StackElem: import("@stitches/react/types/styled-component").StyledComponent<"div", {
...
declare const Stack: React.ForwardRefExoticComponent<Pick<StackProps, "space" | "align" | "key" | keyof React.HTMLAttributes<HTMLDivElement> | "dividers"> & React.RefAttributes<HTMLDivElement>>;
declare type StackProps = ComponentPropsWithRef<'div'> & {
    children?: ReactNode;
